...
class ClassMatcherCreateComponentAlternative extends React.Component {
    ...
    render(){
        ...
        return(
            ...
            { !classMatcherObject && (
                <React.Fragment>
                    <div style={{  marginBottom: '50px',  position:'relative', height: '357px', padding: '25px', background: 'lightgrey', width: '100%'}}>
...
ClassMatcherCreateComponentAlternative.defaultProps = {
    classMatcherObject: undefined
};

export default connect(mapStateToProps, mapDispatchToProps)(ClassMatcherCreateComponentAlternative);